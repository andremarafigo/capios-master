...
class CreateAccountViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = R.string.main.title_createAccountVC()
        ...
        Observable.combineLatest(usernameTxtField.rx.text,
                                 passwordTxtField.rx.text) {
                                    ...
                                    return false
            }.bind(to: createAccountButton.rx.isEnabled).disposed(by: disposeBag)
    }
    ...
    func createAccount() {
        ...
        if valet.canAccessKeychain() {
            if valet.containsObject(forKey: R.string.main.valetUsername()) && valet.containsObject(forKey: R.string.main.valetPassword()) {
                let alert = UIAlertController(title: R.string.main.alertTitleCreateAccountErro(), message: R.string.main.alertMessageCreateAccountErro(), preferredStyle: .alert)
                alert.addAction(UIAlertAction(title: R.string.main.alertTitleButtonCreateAccountErro(), style: .default, handler: nil))
                self.present(alert, animated: true, completion: nil)
                return
            }
            
            //Remove dados do cofre (Keychain)
            //valet.removeObject(forKey: "")
            ...
            if let username = usernameTxtField.text,
                ...
                let alert = UIAlertController(title: R.string.main.alertTitleCreateAccountSucesso(), message: R.string.main.alertMessageCreateAccountSucesso(), preferredStyle: .alert)
                alert.addAction(UIAlertAction(title: R.string.main.alertTitleButtonCreateAccountSucesso(), style: .default, handler: { _ in
